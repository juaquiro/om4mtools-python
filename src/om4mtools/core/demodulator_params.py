...
# with a plain class, a typo in self.demod_params.dummy = 5 silently creates a new attribute. With slots, it raises AttributeError.
...
def _validate(seld, name:str, value: Any)-> Any:
    ...
    if name=="roi_norm_th":
        ...
        if value<1 :
            raise ValueError("n_igrams must be al least 1")
